...
export default function Home() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-blue-800 to-blue-600 py-12 lg:py-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
              ...
              <motion.p 
                className="text-blue-100 text-lg mb-6 max-w-lg"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <motion.h2 
            className="text-3xl font-bold text-center mb-3 text-gray-800 dark:text-white"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p 
            className="text-center text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                icon: <FaTicketAlt className="w-6 h-6 text-blue-700 dark:text-blue-400" />,
                title: "Easy Booking",
                desc: "Simple and intuitive ticket booking process with instant confirmations"
              },
              {
                icon: <svg className="w-6 h-6 text-blue-700 dark:text-blue-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>,
                title: "Real-Time Updates",
                desc: "Get live status updates for your train and journey details"
              },
              {
                icon: <FaMapMarkedAlt className="w-6 h-6 text-blue-700 dark:text-blue-400" />,
                title: "Extensive Coverage",
                desc: "Access to trains across all zones and regions throughout the country"
              },
              {
                icon: <FaMobileAlt className="w-6 h-6 text-blue-700 dark:text-blue-400" />,
                title: "Mobile Friendly",
                desc: "Manage bookings, check status, and get updates on the go"
              }
            ].map((feature, index) => (
              <motion.div 
                key={index}
                className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-600 hover:shadow-md transition-all"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="p-4">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="text-sm bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 px-2 py-0.5 rounded-full">Daily</div>
                  </div>
                  <Link 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="lg:w-3/5 mb-8 lg:mb-0">
              ...
              <motion.p 
                className="text-blue-100 max-w-lg mb-6"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.3 }}
              >
              ...
              <motion.div 
                ...
                transition={{ duration: 0.6, delay: 0.4 }}
              >
                <a href="#" className="flex items-center bg-black hover:bg-gray-900 transition-colors px-5 py-2.5 rounded-lg">
            ...
            <motion.div 
              ...
              transition={{ duration: 0.8, delay: 0.5 }}
            >
              <div className="relative w-60 h-[450px] md:w-64 md:h-[500px]">
                ...
                <div className="absolute inset-2 bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col">
                  <div className="h-8 bg-blue-700 w-full flex items-center justify-center">
                  ...
                  <div className="flex-1 p-4 flex flex-col">
                    ...
                    <div className="flex-1 bg-blue-50 rounded-lg mb-4 flex items-center justify-center p-4">
                      <div className="text-center">
                        <div className="w-12 h-12 bg-blue-700 rounded-full mx-auto flex items-center justify-center mb-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-8 bg-gray-100 rounded-md"></div>
                      <div className="h-8 w-3/4 bg-gray-100 rounded-md"></div>
                    </div>
                  </div>
                </div>
              </div>
